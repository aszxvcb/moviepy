...
function video_generate(ip, port, text, speaker_id) {
  $("#video_generate").addClass("is-loading");

  var uri = 'http://' + ip + ':' + port
  var url = uri + '/generate_video?text=' + encodeURIComponent(text) + "&speaker_id=" + speaker_id;
...
(function(window, document, undefined){
  ...
  function init(){
    ...
    function video_synthesize() {
      ...
      video_generate('0.0.0.0', 51000, text, speaker_id);
